...
public class RegisterDemoFlow {
	...
	String AptValue = "Apartment-1";
	String cityName = "Gkp";
	String stateName = "UP";
	String countryName = "India";
	String emailValue = "shah1791@gmail.com";
	String dODValue = "09/30/24";
	String cnvTimeHHValue = "02";
	String cnvTimeMMValue = "05";
	String mobileNumberValue = "1234567890";
	//String selWebCheckBoxValue = "OFF";
	//String javaCheckBoxValue = "OFF";
	//String devOpsCheckBoxValue = "ON";
	...
	public void navigationToRegisterPage() {	 
		...
		WebElement demoSites = driver.findElement(By.xpath("(//a[@href='#'][normalize-space()='Demo Sites'])[2]"));
		action.moveToElement(demoSites).perform();
		WebElement practiceAutomation = driver.findElement(By.xpath("(//a[@href='#'][normalize-space()='Practice Automation'])[2]"));
	...
	public void registerUser() throws InterruptedException {	  
		...
		jse.executeScript("arguments[0].scrollIntoView();", javaCheckBox);
		Thread.sleep(2000);
